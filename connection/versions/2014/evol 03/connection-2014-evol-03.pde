...
void testexec(int si) {
  if (connectobjs.get(si).isfunc) {
    if (!connectobjs.get(si).execed) {
      ...
      if (connectobjs.get(si).val.equals("exec") || connectobjs.get(si).val.equals("run") || connectobjs.get(si).val.equals("endloop")) {
        ...
        if (connectobjs.get(si).intocons.size() > 0) {
          ...
          connectobjs.get(si).tick = int(connectobjs.get(connectobjs.get(si).intocons.get(0)).val);
        }
